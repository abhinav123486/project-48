...
function preload(){
  ...
  tagImg = loadImage("images/gameImg1.png");
  starImg = loadImage("images/3starImg1.png");
}
...
function draw(){
  ...
  if(gameState === 1){
    ...
    if(score === 45){
      ...
      chef.visible = false;
      tag = createSprite(windowWidth/2, windowHeight/2, 20, 20);
      tag.addImage(tagImg);

      star = createSprite(windowWidth/2, windowHeight/2-150);
